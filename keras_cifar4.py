...
precision1_stoch, recall1_stoch, _ = precision_recall_curve(one_true, stoch_preds[1],  pos_label=1)
...
average_precision1_stoch = average_precision_score(one_true, stoch_preds[1])
