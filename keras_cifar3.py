...
num_epochs = 250 # we iterate 200 times over the entire training set
...
X_train = np.load("/my_data/all_data/X_train.npy")
X_test = np.load("/my_data/all_data/X_test.npy")
y_train = np.load("/my_data/all_data/y_train.npy")
y_test = np.load("/my_data/all_data/y_test.npy")
...
flat = Flatten()(drop_2)
hidden = Dense(hidden_size, activation='relu', kernel_regularizer= l2(reg))(flat)
...
for i in range(len(X_test)):
    preds_df.set_value(index = i, col= "mean_pred_0", value = Yt_hat[:, 0, i, 0].mean())
    preds_df.set_value(index=i, col="mean_pred_1", value=Yt_hat[:, 0, i, 1].mean())
    preds_df.set_value(index=i, col="mean_pred_2", value=Yt_hat[:, 0, i, 2].mean())
    preds_df.set_value(index=i, col="mean_pred_3", value=Yt_hat[:, 0, i, 3].mean())
    preds_df.set_value(index=i, col="mean_pred_4", value=Yt_hat[:, 0, i, 4].mean())
    preds_df.set_value(index=i, col="mean_pred_5", value=Yt_hat[:, 0, i, 5].mean())
    preds_df.set_value(index=i, col="mean_pred_6", value=Yt_hat[:, 0, i, 6].mean())
    preds_df.set_value(index=i, col="mean_pred_7", value=Yt_hat[:, 0, i, 7].mean())
    preds_df.set_value(index=i, col="mean_pred_8", value=Yt_hat[:, 0, i, 8].mean())
    preds_df.set_value(index=i, col="mean_pred_9", value=Yt_hat[:, 0, i, 9].mean())
...
print(average_precision1_stoch)